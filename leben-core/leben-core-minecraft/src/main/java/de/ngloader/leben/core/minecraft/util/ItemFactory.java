...
import de.ngloader.leben.core.minecraft.CustomEnchantment;
...
public class ItemFactory extends ItemStack {
	...
	public static void setFireProof(ItemStack item, boolean fireProof) {
		net.minecraft.world.item.ItemStack handleItem = (net.minecraft.world.item.ItemStack) ReflectionUtil.getField((CraftItemStack) item, "handle");
		ReflectionUtil.setField(Item.class, handleItem.getItem(), "isFireResistant", fireProof);
	}
	...
	public ItemFactory setMap(MapView view) {
		try {
			MapMeta meta = (MapMeta) this.meta;
			meta.setMapView(view);
		} catch (ClassCastException e) {
			throw new ClassCastException("The given item wasn't a filled map");
		}
		return this;
	}
